...
Layers:
  ...
  catchment_localities  mainland localities inside the combined 45-minute
                        catchment, flagged served / underserved by their
                        distance to the nearest competitor. Visualises that
                        most of the population "reached" already has the
                        service locally. Computed once in Step 3 and read from
                        data/processed/catchment.gpkg here, not recomputed.
"""
...
LAYERS = {
    ...
    "catchment_localities": (PROCESSED_DIR / "catchment.gpkg", "catchment_localities"),
}
